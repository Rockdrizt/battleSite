	...
	return {
		...
		update:function () {
			...
			if (game.input.activePointer.isDown){
				if (!clickLatch) {
					var projectiles = characterBattle.getProjectiles()
					var firstProjectile = projectiles["earthExplosion1"]
					var particles = firstProjectile.particles

					for(var particleIndex = 0; particleIndex < particles.length; particleIndex++){
						var firstParticle = particles[particleIndex]

						var particleName = firstParticle.substr(firstParticle.lastIndexOf('/') + 1);
					...
					// var firstProjectile2 = projectiles["fireball2"]
					// firstParticle = firstProjectile2.particles[0]
					//
					// var particleName2 = firstParticle.substr(firstParticle.lastIndexOf('/') + 1);
					// index = particleName2.indexOf(".");
					// particleName2 = particleName2.substring(0, index)
					//
					// var emitter2 = epicparticles.newEmitter(particleName2)
					// emitter2.x = game.input.activePointer.x
					// emitter2.y = game.input.activePointer.y
				}
