...
var vs = function(){
	...
	function setCharacters(characters){
		...
		for(var i = 0; i < characters.length;i++){
			...
			spineList[i]= {}
			var id = character.id
			var data = epicCharacters[id]
			spineList[i].id = character.id
			spineList[i].name = character.nickname
			spineList[i].dir = data.directory
			spineList[i].scale = data.spine.options.scale
			spineList[i].element = data.stats.element
		}
